...
Source0:	hostd-%{version}.tar.gz
Source1:        sia-hostd.service
Source3:        sia-hostd.sysconfig
Source4:        sia-hostd-tmpfiles.conf
...
%install
%{__mkdir_p} %{buildroot}/%{_localstatedir}/lib/sia/hostd
%{__mkdir_p} %{buildroot}/%{_bindir}
%{__mkdir_p} %{buildroot}/%{_sbindir}
%{__mkdir_p} %{buildroot}/%{_var}/log/sia/
export GOPATH=$(pwd)
%{__install} -p -m 0755 $GOPATH/bin/hostd %{buildroot}%{_sbindir}/%{name}
...
%dir %attr(0750, sia,sia) %{_localstatedir}/lib/sia/hostd
